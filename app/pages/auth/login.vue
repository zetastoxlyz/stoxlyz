...
async function handleLogin() {
	...
	const result = await userStore.loginWithFirebase(email.value, password.value);
...
<template>
  <div class="flex min-h-screen flex-col bg-background">
    ...
    <div class="flex flex-1 items-center justify-center px-4">
      ...
      <Button type="button" variant="outline" class="w-full gap-2" @click="handleGoogleLogin" :disabled="loading">
